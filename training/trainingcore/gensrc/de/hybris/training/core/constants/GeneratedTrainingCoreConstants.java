 ...
 * --- Generated at 15-Dec-2021, 10:53:06 AM                    ---
 * ----------------------------------------------------------------
 *  
...
public class GeneratedTrainingCoreConstants
{
	...
	public static class TC
	{
		...
		public static final String TESTPROCESSES = "TestProcesses".intern();
	...
	{
		public static final String DRIVER2DEALER = "Driver2Dealer".intern();
		public static final String DRIVER2VEHICLE = "Driver2Vehicle".intern();
		public static final String VEHICLE2DEALER = "Vehicle2Dealer".intern();
	}
