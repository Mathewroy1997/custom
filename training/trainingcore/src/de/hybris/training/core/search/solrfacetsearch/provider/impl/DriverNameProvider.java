...
public class DriverNameProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider {
    ...
    private Collection<? extends FieldValue> createFieldValue(VehicleModel vehicleList, IndexedProperty indexedProperty) {
        final List<FieldValue> fieldValues = new ArrayList<>();
        final String driverName = vehicleList.getDriver().getDriverName();
        if (driverName != null) {
