...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "trainingcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "trainingcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "trainingcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "trainingcommercewebservices.v2.description";
	private static final String TITLE = "trainingcommercewebservices.v2.title";
	private static final String VERSION = "trainingcommercewebservices.v2.version";
	private static final String LICENSE = "trainingcommercewebservices.v2.license";
	private static final String LICENSE_URL = "trainingcommercewebservices.v2.license.url";
